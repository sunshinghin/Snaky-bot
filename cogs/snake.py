  ...
  if chaos_random == 1 and chaos == "y":
    ...
    #weak
      if self.weak == False and self.angry == False and self.reverse_movement == False:
        ...
        self.snake_char = "🤮"
        self.tail_char = "🟩"
      elif self.angry == False and self.reverse_movement == False:
        self.weak = False
        self.snake_char = "😷"
        self.tail_char = "🟨"
...
class Snake:
  ...
  async def load_grid(self,channel,input,WAIT_TIME,chaos):
      ...
      if channel != None:
        ...
        await sendingembed("\n".join(maparray),channel,False,self,self.score,send_emoji,WAIT_TIME,channel,self.create_message_author,None,chaos)       
